...
if(isset($_POST['btnPinjam'])){
	...
	if(cekPinjam($kon, $id_anggota) && $stok > 0){
		...
		$querp = mysqli_query($kon,"SELECT id_pinjam FROM peminjaman WHERE tgl_pinjam='$tgl_pinjam' AND id_anggota='$id_anggota' AND tgl_pinjam_tempo='$tgl_jatuh_tempo' AND id_petugas='$id_petugas' ");
