        ...
        <div class = "col-md">
            ...
            <div class = "card" style = "width: 100%;">
                ...
                <table class = "table">
                    ...
                    <tr>
                        <td>Ringkasan</td>
                        <td style=""><textarea style="width:100%; height: 100px;" value="<?= $buku['cover']; ?>" type="textarea" name
                        ="ringkasan" required><?= $buku['ringkasan']; ?></textarea></td>
                    </tr><input style="width:100%" type="hidden" name="cover" value="<?= $buku['cover']; ?>">
                    <tr>
                        <td>Stok</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select style="width:100%" name="id_kategori" required>
                                option>
                                <?php
                                    $query = mysqli_query($kon, "SELECT * FROM buku INNER JOIN kategori ON buku.id_kategori = kategori
                                        .id_kategori WHERE id_buku=$id_buku");
